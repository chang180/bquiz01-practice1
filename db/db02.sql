...
CREATE TABLE `admin` (
  ...
  `pw` text COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(2, 'index.php?do=login', '管理登入', 1, 0),
(3, 'index.php', '網站首頁', 1, 0),
(4, 'index.php?do=news', '更多內容', 1, 3),
(7, 'asdfasdf', 'adsfasdf', 1, 0),
(8, 'asdfasf', 'asdfas', 1, 7),
(10, 'asdfasdf', 'asdfasdf', 1, 7),
(11, 'adsf', 'asdf', 1, 7),
(12, 'asdf', 'asdf', 1, 7);
...
(5, '01B03.jpg', '科技大學校園資訊管理系統', 0),
(6, '01B01.jpg', '科技大學校園資訊管理系統', 0),
(7, '01B02.jpg', '科技大學校園資訊管理系統', 0),
(8, '01B04.jpg', '科技大學校園資訊管理系統', 1);
